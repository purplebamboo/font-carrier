  ...
  <font id="<%= font.id %>" horiz-adv-x="<%= font.horizAdvX %>" vert-adv-y="<%= font.horizAdvX %>" >
    ...
    />
      ...
      <% for(var i in glyphs){
       ...
       %>
      <glyph glyph-name="<%= glyph['glyphName'] %>" unicode="<%= glyph['unicode']%>" d="<%= glyph['d']%>"  <% if (typeof glyph['horizAdvX'] === 'number') print('horiz-adv-x="'+ glyph['horizAdvX']+'"') %> <% if (typeof glyph['vertAdvY'] === 'number') print('vert-adv-y="'+ glyph['vertAdvY']+'"') %>  />
